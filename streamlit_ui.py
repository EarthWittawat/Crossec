...
tissue = [
 'รากพืชใบเลี้ยงคู่ระยะปฐมภูมิ2', 'ลำต้นพืชใบเลี้ยงคู่ระยะปฐมภูมิ', 'ลำต้นพืชใบเลี้ยงคู่ระยะทุติยภูมิ','รากพืชใบเลี้ยงเดี่ยวระยะปฐมภมิ','ลำต้นพืชใบเลี้ยงเดี่ยวระยะปฐมภูมิ'
]
